# Generated by Django 2.2.5 on 2020-03-07 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.OneToOneField(blank=True, db_column='image', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='image', to='common.Attachment', verbose_name='图片')),
            ],
            options={
                'db_table': 'product',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort', models.IntegerField(default=0, verbose_name='排序')),
                ('status', models.SmallIntegerField(choices=[[0, '正常'], [9, '禁用']], db_index=True, default=0, verbose_name='状态')),
                ('logo', models.OneToOneField(blank=True, db_column='logo', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='common.Attachment', verbose_name='Logo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, null=True, verbose_name='详情')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='common.Category', verbose_name='栏目')),
                ('image', models.OneToOneField(blank=True, db_column='image', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='common.Attachment', verbose_name='图片')),
            ],
            options={
                'db_table': 'article',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.OneToOneField(db_column='image', on_delete=django.db.models.deletion.DO_NOTHING, to='common.Attachment', verbose_name='图片')),
            ],
            options={
                'db_table': 'adv',
                'abstract': False,
